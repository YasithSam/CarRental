...
function component($owner_id,$id,$vehicle_title,$vehicles_brand,$seats,$rating,$status,$price_per_km,$city,$vimage1){
    ...
    <form action=\"../CarRental/booking/book.php\" method=\"post\" class=\"example-1 card\" style=\"width:100%\">
        <div class=\"example-1 card\" style=\"margin-top:20px; \">
            <div class=\"wrapper\">
                    ...
                    <div class=\"image\">
                        <img class=\"book-image\" src=\"../CarRental/images/$vimage1\"/ style=\"height:100%\">
                    </div>
